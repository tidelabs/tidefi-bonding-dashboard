  ...
  setup (props) {
    ...
    const chartOptions = computed(() => {
      const options = {
        ...
        xAxis: {
          categories: props.commissionHistory
            ? props.commissionHistory.map((history) => eraToDate(history.era) + ` (${ history.era })`)
            : [],
          crosshair: true,
          title: {
            text: 'Eras',
        ...
        series: [{
          name: 'Validator Percentage',
          data: props.commissionHistory
            ? props.commissionHistory.map((history) => history.commission)
            : []
        }]
      }
